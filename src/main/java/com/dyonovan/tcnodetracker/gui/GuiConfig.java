...
public class GuiConfig extends GuiScreen {
    ...
    private void drawButtons() {
        ...
        if (ConfigHandler.arrowSize >= 1) arrowLarge.enabled = false;
        else if (ConfigHandler.arrowSize <= 0.05) arrowSmall.enabled = false;
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case RESET:
                ...
                break;
            case ARROW_TYPE:
                if (ConfigHandler.altArrow) ConfigHandler.altArrow = false;
                else if (!ConfigHandler.altArrow) ConfigHandler.altArrow = true;
                break;
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        fr.drawString(
                StatCollector.translateToLocal("str.configarrow.name"),
        ...
        fr.drawString(
                "Size: " + Math.round(ConfigHandler.arrowSize * 100) + "%",
                ((width / 4) * 3) + 12,
                height - 43,
                Constants.WHITE);
